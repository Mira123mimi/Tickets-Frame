...
public class TicketsFrame extends JFrame
{
   ...
   public TicketsFrame()
   {
       ...
       surnmamePnl  = new JPanel(new FlowLayout(FlowLayout.LEFT));
       ...
       ticketsBtnCombinedPnl.add(btnPnl, BorderLayout.SOUTH);
       ...
       //add main to the panel of the current frame
       add(mainPnl);
